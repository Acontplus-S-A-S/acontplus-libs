...
declare class SvgIconComponent {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<SvgIconComponent, "lib-svg-icon", never, { "id": { "alias": "id"; "required": false; "isSignal": true; }; "width": { "alias": "width"; "required": false; "isSignal": true; }; "height": { "alias": "height"; "required": false; "isSignal": true; }; "color": { "alias": "color"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
