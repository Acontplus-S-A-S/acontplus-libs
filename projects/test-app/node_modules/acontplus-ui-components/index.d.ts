...
declare class MatDialogService {
     ...
     */
    open<T, D = any, R = any>(component: ComponentType<T>, config?: MatCustomDialogConfig<D>): MatDialogRef<T, R>;
    /**
     * Opens a dialog and returns only the result observable
     */
    openAndGetResult<T, D = any, R = any>(component: ComponentType<T>, config?: MatCustomDialogConfig<D>): Observable<R | undefined>;
    /**
     * Opens a confirmation dialog (helper method)
     */
    openConfirmation<T>(component: ComponentType<T>, data?: any, config?: Partial<MatCustomDialogConfig>): Observable<boolean>;
    /**
    ...
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<MatDialogService, never>;
    static ɵprov: _angular_core.ɵɵInjectableDeclaration<MatDialogService>;
}
...
export { ActiveRequestsTracker, ColumnDefinition, CustomTabulatorComponent, DEFAULT_SNACKBAR_CONFIG, DYNAMIC_INPUT, FieldDefinition, GetTotalPipe, IconUserComponent, MatCustomDialogComponent, MatDialogService, MatDynamicTableComponent, MatInputChipComponent, MatThemeButtonComponent, OverlayService, Pagination, SNACKBAR_CONFIG, SNACKBAR_DURATIONS, SNACKBAR_ICONS, SNACKBAR_MESSAGES, SnackbarNotificationComponent, SnackbarService, SpinnerComponent, SvgIconComponent, TableCellIndex, ThemeService, ThemeToggleComponent, spinnerInterceptor, withoutSpinner };
export type { ButtonType, ButtonVariant, ColumnType, ControlType, DateRangeConfig, DialogPosition, DialogSize, FieldType, MatCustomDialogConfig, MatCustomDialogOptions, MaterialButtonStyle, NotificationCallProps, NotificationDemo, OptionSearchConfig, SnackbarConfig, SnackbarProps, SnackbarType };
