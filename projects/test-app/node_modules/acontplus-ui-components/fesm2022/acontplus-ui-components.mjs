...
import { input, output, Component, ViewChild, Pipe, InjectionToken, inject, ViewContainerRef, Injector, EventEmitter, Input, ContentChildren, ContentChild, Output, ChangeDetectionStrategy, Injectable, signal } from '@angular/core';
...
class OverlayService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.3", ngImport: i0, type: OverlayService, deps: [{ token: i1$1.Overlay }], target: i0.ɵɵFactoryTarget.Injectable }); }
