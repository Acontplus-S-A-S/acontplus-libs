import { getValidId, isValidField } from 'acontplus-core/src/lib/utils/field.util';
import { DateUtils } from 'acontplus-core/src/lib/utils';
...
export class CustomerCreateUpdateMapper {
  static toJson(param: any) {
    return {
      ...
      birthDate: DateUtils.isValid(param.birthDate) ? DateUtils.toUTCString(param.birthDate) : null,
    };
  }
