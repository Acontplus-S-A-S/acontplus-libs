...
export const REPOSITORY_REGISTRATIONS = new InjectionToken<RepositoryRegistration[]>('REPOSITORY_REGISTRATIONS');
...
export function provideRepositoryRegistrations(registrations: RepositoryRegistration[]): Provider[] {
  return [
        ...
        return () => {
          ...
          items.forEach(r => {
            try {
              ...
              factory.createFullRepository({ type: r.type as any, entityName: r.entityName, baseUrl: r.baseUrl, aliasKey: r.key });
            } catch {
