...
describe('AuthUrlRedirect', () => {
  let service: AuthUrlRedirect;
  let router: Router;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(AuthUrlRedirect);
  ...
  describe('SSR environment', () => {
    let ssrService: AuthUrlRedirect;
    ...
    beforeEach(() => {
      ...
      ssrService = TestBed.inject(AuthUrlRedirect);
    });
